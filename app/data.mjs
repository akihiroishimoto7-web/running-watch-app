...
export const step1Results = {
  garmin: {
    ...
    fits: [
      "週3回以上走る、月100km以上の走り込みをしている",
      "サブ4・自己ベスト更新など明確な目標がある",
      "ペース・心拍・トレーニング負荷を見ながら走りたい",
      "Training Readiness や Body Battery で体調管理したい",
      "充電は週1回くらいに抑えたい",
    ],
  },
  apple: {
    ...
    fits: [
      "iPhoneの通知・決済・音楽を腕で完結させたい",
      "ランは月10〜30km、健康習慣として続けたい",
      "デザインやバンドの選択肢で自分らしくカスタムしたい",
      "心電図・血中酸素・睡眠まで一元管理したい",
      "毎日つけたくなる「続けやすさ」を最優先したい",
    ],
  },
  middle: {
...
export const step2Questions = [
  ...
  {
    id: "q2",
    question: "サブ4・自己ベストを狙っていますか？",
    help: "サブ4＝フルマラソンを4時間未満で完走すること。市民ランナーの代表的な目標タイムです。",
  },
