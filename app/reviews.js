...
export const reviews = {
  ...
  "coros-pace-4": {
    ...
    hero:
      "2025年11月発売。前モデル PACE 3 から MIP→AMOLED への画面刷新、GPS バッテリーの大幅延長、本体音楽保存対応、内蔵マイクの追加など、見える部分も見えない部分も丁寧にアップデートされた一本。参考価格は約36,300円とむしろ前モデルより手頃で、Garmin Forerunner 165 / 265 と直接比較する価値がさらに上がった。",
    forWhom: [
    ...
    specs: [
      ...
      {
        label: "バッテリー",
        value: "スマートウォッチ最大19日 / GPS最大41時間",
      },
      { label: "GPS", value: "デュアル周波数 (L1+L5) / 全衛星システム対応" },
      {
        label: "重量",
      ...
      {
        label: "音楽",
        value: "本体保存対応（4GB / 内蔵マイク搭載）",
      },
      { label: "充電端子", value: "USB Type-C" },
      { label: "価格", value: "約36,300円（参考価格）" },
    ],
    impressions: [
      ...
      "GPSは引き続きデュアル周波数で、街中・林間・高架下のいずれでも軌跡が安定する。最大の進化はGPSバッテリーが41時間に伸びたこと。PACE 3 でも十分だった持続時間が、ウルトラやステージレースまで現実的にカバーできるレベルになった。本体に音楽を保存して Bluetooth イヤホンで再生できるようになったのも、スマホを置いて走りたい人には大きい。",
    ],
    highlights: [
      {
        title: "AMOLEDへの画面刷新",
      ...
      {
        title: "GPS 41時間バッテリー",
        body: "前モデルから16時間延長。フルマラソン10本以上を走れる計算で、ウルトラまで現実的に対応。",
      },
      {
        title: "音楽の本体保存に対応",
      ...
      {
        title: "36,300円という価格",
        body: "PACE 3とほぼ同価格帯のまま機能が大きく進化。Garmin Forerunner 165と比較すると性能で先行する場面が多い。",
      },
    ],
    drawbacks: [
      {
