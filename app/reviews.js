...
export const reviews = {
  ...
  "forerunner-265": {
    ...
    relatedModels: [
      { slug: "forerunner-570", reason: "ダイナミクス+地図の上位機" },
      { slug: "forerunner-965", reason: "最上位の本格モデル" },
  ...
  "forerunner-570": {
    ...
    brand: "Garmin",
    image: "/reviews/forerunner-570.jpg",
    tagline: "手首だけでランニングダイナミクス。265の次に選ぶ実力機。",
    hero:
      "2025年発売の Forerunner 570 は、265 と 965 の間を埋める「中核上位機」。最大の特徴は、追加センサーなしに手首から走りの質を計測できる「リストベース ランニングダイナミクス」と、265には搭載されなかった地図機能の内蔵。マルチバンドGPS・AMOLED・音楽保存はもちろん、サブ4から先を本気で狙う中級〜上級者に過不足ない仕様を揃えた。",
    forWhom: [
      "Forerunner 265 から次のステップに進みたい",
      "ケイデンス・ストライド・垂直振動をセンサーなしで計測したい",
      "地図を見ながら知らないコースやトレイルを走りたい",
      "フルマラソン・サブ3.5を本気で狙っている",
    ],
    specs: [
      { label: "ディスプレイ", value: "1.3インチ AMOLED (416×416)" },
      {
        label: "バッテリー",
        value: "スマートウォッチ最大20日 / GPS最大24時間 / マルチバンド最大13時間",
      },
      { label: "GPS", value: "マルチバンド (L1+L5) / 全衛星システム対応" },
      { label: "重量", value: "約49g" },
      { label: "防水性能", value: "5ATM" },
      { label: "音楽保存", value: "対応 / Wi-Fi同期" },
      { label: "内蔵地図", value: "TopoActive 地形図" },
      {
        label: "ランニングダイナミクス",
        value: "リストベース（追加センサー不要）",
      },
      { label: "価格", value: "約79,800円前後" },
    ],
    impressions: [
      "265から乗り換えて真っ先に感じるのが、ランニングダイナミクスの手軽さ。265でも心拍センサーとの連携でペース・心拍は取れるが、ケイデンス・垂直振動比・接地時間バランスなどの走りの質を知るには別途センサーが必要だった。570は手首センサーだけでこれらが計測でき、走法改善に直接役立つ数字が増える。",
      "地図機能は、ランニングの行動半径を広げてくれる。見知らぬ街でのラン、峠を使ったロング走、初参加のトレイルレース — ルート確認アプリを別に持たなくていい安心感は、慣れると手放せなくなる。GPSマルチバンドの精度とAMOLEDの大画面で、走行中の情報確認も快適だ。",
    ],
    highlights: [
      {
        title: "リストベース ランニングダイナミクス",
        body: "追加センサーなしで垂直振動・接地時間・ストライド長を計測。フォーム改善に直結するデータが手首だけで揃う。",
      },
      {
        title: "TopoActive 地形図の内蔵",
        body: "知らないコースや峠のトレイルを地図で確認しながら走れる。265との最大差別点のひとつ。",
      },
      {
        title: "マルチバンドGPS精度",
        body: "265と同等クラスの精度。市街地・木立の中でも軌跡が乱れにくい。",
      },
      {
        title: "Training Readiness + Real-Time Stamina",
        body: "「今日走れるか」「あと何分このペースを保てるか」が両方わかる。レース終盤のペース管理に強い。",
      },
      {
        title: "スマートウォッチ最大20日バッテリー",
        body: "普段使いとロング走を両立できる。265（13日）より余裕が増した。",
      },
    ],
    drawbacks: [
      {
        title: "約79,800円という価格",
        body: "265より約1〜1.5万円高い。ダイナミクスと地図に価値を感じない人は265で十分。",
      },
      {
        title: "マルチバンドGPS時のバッテリー（約13時間）",
        body: "ウルトラや100km超のレースはGPS時間が足りないことがある。そのシーンなら965が現実解。",
      },
      {
        title: "約49gの重量",
        body: "265S（39g）より重い。軽量さを最優先するなら265S や PACE 4 が有利。",
      },
    ],
    useCases: [
      { label: "5km / ジョグ", rating: 5, comment: "余裕の精度" },
      { label: "10km / 閾値走", rating: 5, comment: "ダイナミクスでフォーム確認できる" },
      {
        label: "ハーフマラソン",
        rating: 5,
        comment: "ペース管理・ダイナミクスともに完璧に機能",
      },
      {
        label: "フルマラソン",
        rating: 5,
        comment: "サブ3.5〜サブ3クラスの本命機材",
      },
      {
        label: "ウルトラ・トレイル",
        rating: 3,
        comment: "マルチバンド13時間がボーダーライン。長距離は965へ",
      },
      { label: "普段使い", rating: 4, comment: "AMOLEDで満足度高い" },
    ],
    bestFor:
      "Forerunner 265 に「ランニングダイナミクスと地図が欲しい」と感じているランナー。フルマラソンでサブ3.5〜サブ3を狙う中級〜上級者に最もフィットする。",
    notFor:
      "ウルトラマラソンや100km超のレースをメインにする人 (965へ)・予算重視の人 (265 や PACE 4 を)・初めてランニングウォッチを買う人 (165 から)",
    conclusion:
      "「265 でもう少し上が欲しい、でも 965 は大げさ」という層に刺さる、2025年の新定番候補。ランニングダイナミクスを外付けセンサーなしで完結させ、地図機能まで追加したことで、265 との差は価格差以上にある。長く走り続けるランナーの相棒として、投資価値が高い1本。",
    relatedModels: [
      { slug: "forerunner-265", reason: "1ランク下でコスパ良し" },
      { slug: "forerunner-965", reason: "ウルトラ・地図の最上位機" },
    ],
  },
  ...
  "forerunner-965": {
    ...
    relatedModels: [
      { slug: "forerunner-570", reason: "フルまでなら1ランク下で十分" },
      { slug: "forerunner-265", reason: "さらに価格を抑えるなら" },
